...
internal fun LightspeedNotchOverlay.handleDraw(canvas: Canvas, superCall: () -> Unit) {
        ...
        if (isExpanded) {
            ...
            if (expandedPageIndex == 0) {
                ...
                val capsuleWidgetId = renderCache.capsuleWidgetId
        ...
        val scrollMode = renderCache.scrollMode
        val truncateAnchor = renderCache.truncateAnchor
        ...
        if (textW <= availableW) {
            ...
            if (isLoopingActive) {
                val scrollSpeed = (renderCache.marqueeSpeed.toFloat()) * d
