...
fun rememberCentralCommandState(
    ...
    val pinnedSection0State = rememberSaveable { mutableStateOf(prefs.getString(LightspeedPreferences.KEY_TAB_PINNED_ACCORDION_0, "left_unified_gestures") ?: "left_unified_gestures") }
    val pinnedSection0 by pinnedSection0State
    val sectionOrder0StrState = rememberSaveable { mutableStateOf(prefs.getString(LightspeedPreferences.KEY_TAB_SECTION_ORDER_0, "left_center,left_unified") ?: "left_center,left_unified") }
    ...
    val pinnedSection2State = rememberSaveable { mutableStateOf(prefs.getString(LightspeedPreferences.KEY_TAB_PINNED_ACCORDION_2, "unified_gestures") ?: "unified_gestures") }
    val pinnedSection2 by pinnedSection2State
    val sectionOrder2StrState = rememberSaveable { mutableStateOf(prefs.getString(LightspeedPreferences.KEY_TAB_SECTION_ORDER_2, "center,unified") ?: "center,unified") }
    ...
    val isLeftTopExpandedState = rememberSaveable { mutableStateOf(if (tabMode0 == "all_expanded") true else if (tabMode0 == "all_collapsed") false else if (tabMode0 == "custom_pinned") pinnedSection0 == "left_top" || pinnedSection0.startsWith("left_top_") else prefs.getBoolean("pref_section_left_top_expanded", false)) }
    ...
    val isLeftFlankUnifiedState = rememberSaveable { mutableStateOf(prefs.getBoolean("pref_sidebar_left_link_flank_actions", true)) }
    val isLeftFlankUnified by isLeftFlankUnifiedState
    val isLeftUnifiedExpandedState = rememberSaveable { mutableStateOf(if (tabMode0 == "all_expanded") true else if (tabMode0 == "all_collapsed") false else if (tabMode0 == "custom_pinned") pinnedSection0 == "left_unified" || pinnedSection0.startsWith("left_unified_") else prefs.getBoolean("pref_section_left_unified_expanded", true)) }
    ...
    val isLeftUnifiedGeoExpandedState = rememberSaveable { mutableStateOf(if (tabMode0 == "custom_pinned" && pinnedSection0.contains("_")) pinnedSection0 == "left_unified_geo" else prefs.getBoolean("pref_sub_geo_left_unified", false)) }
    val isLeftUnifiedScrubExpandedState = rememberSaveable { mutableStateOf(if (tabMode0 == "custom_pinned" && pinnedSection0.contains("_")) pinnedSection0 == "left_unified_scrub" else prefs.getBoolean("pref_sub_scrub_left_unified", false)) }
    ...
    val isLeftTopGeoExpandedState = rememberSaveable { mutableStateOf(if (tabMode0 == "custom_pinned" && pinnedSection0.contains("_")) pinnedSection0 == "left_top_geo" else prefs.getBoolean("pref_sub_geo_left_top", false)) }
    val isLeftTopScrubExpandedState = rememberSaveable { mutableStateOf(if (tabMode0 == "custom_pinned" && pinnedSection0.contains("_")) pinnedSection0 == "left_top_scrub" else prefs.getBoolean("pref_sub_scrub_left_top", false)) }
    ...
    val isLeftBottomGeoExpandedState = rememberSaveable { mutableStateOf(if (tabMode0 == "custom_pinned" && pinnedSection0.contains("_")) pinnedSection0 == "left_bottom_geo" else prefs.getBoolean("pref_sub_geo_left_bottom", false)) }
    val isLeftBottomScrubExpandedState = rememberSaveable { mutableStateOf(if (tabMode0 == "custom_pinned" && pinnedSection0.contains("_")) pinnedSection0 == "left_bottom_scrub" else prefs.getBoolean("pref_sub_scrub_left_bottom", false)) }
    ...
    val isTopExpandedState = rememberSaveable { mutableStateOf(if (tabMode2 == "all_expanded") true else if (tabMode2 == "all_collapsed") false else if (tabMode2 == "custom_pinned") pinnedSection2 == "top" || pinnedSection2.startsWith("top_") else prefs.getBoolean("pref_section_top_expanded", false)) }
    ...
    val isRightFlankUnifiedState = rememberSaveable { mutableStateOf(prefs.getBoolean(LightspeedPreferences.KEY_SIDEBAR_RIGHT_LINK_FLANK, true)) }
    val isRightFlankUnified by isRightFlankUnifiedState
    val isRightUnifiedExpandedState = rememberSaveable { mutableStateOf(if (tabMode2 == "all_expanded") true else if (tabMode2 == "all_collapsed") false else if (tabMode2 == "custom_pinned") pinnedSection2 == "unified" || pinnedSection2.startsWith("unified_") else prefs.getBoolean("pref_section_right_unified_expanded", true)) }
    ...
    val isRightUnifiedGeoExpandedState = rememberSaveable { mutableStateOf(if (tabMode2 == "custom_pinned" && pinnedSection2.contains("_")) pinnedSection2 == "unified_geo" else prefs.getBoolean("pref_sub_geo_right_unified", false)) }
    val isRightUnifiedScrubExpandedState = rememberSaveable { mutableStateOf(if (tabMode2 == "custom_pinned" && pinnedSection2.contains("_")) pinnedSection2 == "unified_scrub" else prefs.getBoolean("pref_sub_scrub_right_unified", false)) }
    ...
    val isTopGeoExpandedState = rememberSaveable { mutableStateOf(if (tabMode2 == "custom_pinned" && pinnedSection2.contains("_")) pinnedSection2 == "top_geo" else prefs.getBoolean("pref_sub_geo_top", false)) }
    val isTopScrubExpandedState = rememberSaveable { mutableStateOf(if (tabMode2 == "custom_pinned" && pinnedSection2.contains("_")) pinnedSection2 == "top_scrub" else prefs.getBoolean("pref_sub_scrub_top", false)) }
    ...
    val isBottomGeoExpandedState = rememberSaveable { mutableStateOf(if (tabMode2 == "custom_pinned" && pinnedSection2.contains("_")) pinnedSection2 == "bottom_geo" else prefs.getBoolean("pref_sub_geo_bottom", false)) }
    val isBottomScrubExpandedState = rememberSaveable { mutableStateOf(if (tabMode2 == "custom_pinned" && pinnedSection2.contains("_")) pinnedSection2 == "bottom_scrub" else prefs.getBoolean("pref_sub_scrub_bottom", false)) }
                ...
                if (!currentExpanded) {
                    when (tabId) {
                        ...
                        1 -> {
                            ...
                            if (pinned != "system_overrides") isSystemOverridesExpanded = false
    ...
    val navState = CentralCommandNavState(
    ...
    val leftDeflectorState = DeflectorAccordionState(
    ...
    val rightDeflectorState = DeflectorAccordionState(
    ...
    val hudStripState = HudStripAccordionState(
    ...
    val dialogState = CentralCommandDialogState(
    ...
    return CentralCommandState(
        nav = navState,
        leftDeflector = leftDeflectorState,
        rightDeflector = rightDeflectorState,
        hudStrip = hudStripState,
        dialogs = dialogState,
