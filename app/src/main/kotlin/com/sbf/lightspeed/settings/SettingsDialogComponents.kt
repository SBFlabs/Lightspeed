...
fun CentralCommandDeckDialog(
    ...
    initialScrollToWatchdog: Boolean = false
) {
    ...
    Dialog(
        ...
        Box(
            ...
            Card(
                ...
                var watchdogY by remember { mutableIntStateOf(0) }

                LaunchedEffect(watchdogY, initialScrollToWatchdog) {
                    if (initialScrollToWatchdog && watchdogY > 0) {
                        scrollState.animateScrollTo(watchdogY)
                    }
                }
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .onGloballyPositioned { coordinates ->
                                watchdogY = (coordinates.positionInParent().y.roundToInt() - with(density) { 8.dp.toPx() }.roundToInt()).coerceAtLeast(0)
                            }
                    ) {
