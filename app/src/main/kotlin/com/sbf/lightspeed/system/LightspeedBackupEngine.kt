                        ...
                        when (value) {
                            "true", "false" -> {
                                ...
                                if (key == LightspeedPreferences.KEY_BACK_TAP_THRESHOLD) {
                                    ...
                                    if (intVal != null && (key.startsWith("pref_sidebar_") || key.startsWith("pref_statusbar_") || key.startsWith("pref_notch_") || key.startsWith("pref_horizon_rail_") || key.startsWith("last_active_set_index") || key == LightspeedPreferences.KEY_REFUELING_WIDGET_ID || key == LightspeedPreferences.KEY_CAPSULE_WIDGET_ID)) {
